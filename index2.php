...
<head>
    ...
    <!-- Libreria de cdn para las alertas -->
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">"Sistema de Gestión para Salones de Belleza y Barberías"</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href = "<?php echo $URL;?>/" class="brand-link">
                <img src="https://sadebb.com/imagenes-sadebb/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">  SADEBB  </span>
            </a>
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="<?php echo $URL;?>/usuarios/listar_usuarios.php" class="nav-link ">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Listados de Usuarios</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo $URL;?>/usuarios/crear_usuarios.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
        ...
        <li class="nav-item">
            <a href="<?php echo $URL; ?>/app/controllers/login/cerrar_sesion.php" class="nav-link" style ="background-color: #A82A15">
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Bienvenidos a Sadebb</h1>
...
<footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
        "Liberta de con el tiempo"
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2023 <a href="https://www.spi-pty.com">spi-pty</a>.</strong> Todos los derechos Reservados.
</footer>
</div>
<!-- ./wrapper -->
