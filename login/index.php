...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
        <img src="https://sadebb.com/imagenes-sadebb/logo-m.png" alt="" width="100" height="">
<br><br>
        <a href="../public/template/AdminLTE-3.2.0/index2.html" class="h5"><b>Sistema Administrativo para Salones de Bellezas y Barberias</b></a>
    </div>
    <div class="card-body">
